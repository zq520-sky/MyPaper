				...
				$(function () {
					...
					$('#dataList').datagrid({
						...
						columns: [[
							...
							{field: 'clazzId', title: '任课班级', width: 150,formatter:function (value) {
									for(var i = 0; i < clazzListJson.length; i++) {
										if (clazzListJson[i].id == value) {
					...
					$("#search-btn").click(function () {
						$('#dataList').datagrid('load', {
							username: $('#search-teachername').val(),//获取教师名称
...
<div id="toolbar">
	...
	<div style="margin-left: 10px;">
		...
		<input id="search-teachername" class="easyui-textbox" name="username"/>
		<!-- 搜索按钮 -->
			...
			<tr>
				...
				<td colspan="1">
					<select id="add_clazz_name" style="width: 200px; height: 30px;" class="easyui-combobox"
							name="clazzId" data-options="required:true, missingMessage:'请选择所属班级哟~'">
						<c:forEach items="${clazzList}" var="clazz">
							<option value="${clazz.id}">${clazz.name}</option>
						</c:forEach>
					</select>
...
<div id="editDialog" style="padding: 20px 0 0 65px">
	...
	<%-- <div style="float: right; margin: 15px 40px 0 0; width: 250px; border: 1px solid #EEF4FF" id="edit-photo">
         <img id="edit-portrait" alt="照片" style="max-width: 250px; max-height: 300px;" title="照片"
              src="/image/portrait/default_student_portrait.png"/>
         <!-- 头像信息表单 -->
			...
			<tr>
				...
				<td colspan="1">
					...
					<input id="edit_tno" data-options="readonly: true" style="width: 200px; height: 30px;"
						   name="tno" class="easyui-textbox" type="text"/>
				</td>
			</tr>
			<tr>
				<td>邮箱</td>
